...
Codex provides built-in commands, and the typeahead also includes locally installed skills for quick insertion. For full details, see the [Codex slash commands documentation](https://developers.openai.com/codex/cli/slash-commands/) and [Codex skills documentation](https://developers.openai.com/codex/skills/).
...
Any local Codex skills discovered from your configuration directories also appear in the typeahead. Selecting one inserts the matching `$skill-name` invocation into the composer.
